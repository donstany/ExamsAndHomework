	...
	public static void main(String[] args) {
		...
		for (String name : grades.keySet()) {
			...
			for (String subject : grades.get(name).keySet()) {
				int countOfMarks = grades.get(name).get(subject).size(); //no
				
				double sum = 0;  // sum all grades of student
