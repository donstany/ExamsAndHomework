...
public class _03_WeirdStrings {
	public static void main(String[] args) {
		...
		for (int i = 0; i < weights.length - 1; i++) { // weights.length -1 because we work with couples
	...
	public static int getWeight(String word) {
		int sum = 0;
		for (int i = 0; i < word.length(); i++) { // convert from a to z , from 1 to 26
